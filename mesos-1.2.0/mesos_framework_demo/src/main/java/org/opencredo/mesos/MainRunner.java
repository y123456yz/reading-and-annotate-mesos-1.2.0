...
public class MainRunner {
    ...
    static String command = "nohup java -cp /vagrant/example-framework-1.0-SNAPSHOT-jar-with-dependencies.jar org.opencredo.mesos.ExampleExecutor > /yyz.log";
    ...
    public static void main(String[] args) throws Exception {
        runFramework("172.23.133.32:5050");
    }
}
