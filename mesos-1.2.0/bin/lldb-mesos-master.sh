...
. /home/yangyazhou/mesos-1.2.0/support/colors.sh

LIBTOOL=/home/yangyazhou/mesos-1.2.0/libtool
...
. /home/yangyazhou/mesos-1.2.0/bin/mesos-master-flags.sh

exec ${LIBTOOL} --mode=execute lldb -- \
  /home/yangyazhou/mesos-1.2.0/src/mesos-master "${@}"
