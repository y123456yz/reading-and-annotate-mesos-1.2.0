...
: ${MESOS_LAUNCHER_DIR:="/home/yangyazhou/mesos-1.2.0/src"}
...
if test $(uname) = 'Darwin'; then
  : ${MESOS_NATIVE_JAVA_LIBRARY:="/home/yangyazhou/mesos-1.2.0/src/.libs/libmesos-1.2.0.dylib"}
  : ${MESOS_NATIVE_LIBRARY:="/home/yangyazhou/mesos-1.2.0/src/.libs/libmesos-1.2.0.dylib"}
else
  : ${MESOS_NATIVE_JAVA_LIBRARY:="/home/yangyazhou/mesos-1.2.0/src/.libs/libmesos-1.2.0.so"}
  : ${MESOS_NATIVE_LIBRARY:="/home/yangyazhou/mesos-1.2.0/src/.libs/libmesos-1.2.0.so"}
fi
